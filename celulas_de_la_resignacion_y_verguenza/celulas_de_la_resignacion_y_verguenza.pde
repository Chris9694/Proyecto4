...
void setup() {
  ...
  //CELULAS
  cells.add(new Cell(100,400,68,#ff0000));
  cells.add(new Cell(300,400,68,#ffff00));
  cells.add(new Cell(500,400,68,#00ff00));
  cells.add(new Cell(700,400,68,#0000ff));
  cells.add(new Cell(900,400,68,#00ffff));
  cells.add(new Cell(1100,400,68,#ff00ff));
  
  //IMAGEN
  llora = loadImage("cry.png");
}
